...
@section('content')
    ...
    <div class="table-responsive">
        ...
        <x-button.create url="tournament/group/{{ $data->slug }}" />
        <table class="table">
            <tr>
                <th>#</th>
                <th>Group</th>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-2">
                            <x-button.detail url="tournament/group/{{ $data->slug }}" :id="$g->slug" />
                            <x-button.delete url="tournament/group/{{ $data->slug }}" :id="$g->slug" />
                        </div>
                    </td>
                </tr>
            @endforeach
