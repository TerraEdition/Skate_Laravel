                ...
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <div id="modal_mode_input" class="d-flex justify-content-center align-content-center">
                            <input type="number" min="0" class="form-control" id="input_minute" placeholder="Menit">
                            <input type="number" min="0" class="form-control" id="input_seconds"
                                placeholder="Detik">
                            <input type="number" min="0" class="form-control" id="input_miliseconds"
                                placeholder="Milidetik">
                        </div>
                    </div>
                    <div class="mt-3">
                        <input type="checkbox" value="DNS" id="dns">
                        <label for="dns">Tidak Dapat Menyelesaikan Pertandingan (DNS)</label>
                    </div>
                </div>
