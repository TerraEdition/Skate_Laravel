...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <div data-participant_id="{{ $p->participant_id }}" data-participant_number="{{ $p->no_participant }}" data-participant_name="{{ $p->member }}" class="btn btn-sm btn-primary" id="show_stopwatch">
                    Mulai
                </div>
            </td>
        </tr>
