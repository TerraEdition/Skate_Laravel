<div class="container side-height">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item w-auto p-1" role="presentation">
            <button class="nav-link active" id="app-tab" data-bs-toggle="tab" data-bs-target="#app-tab-pane" type="button" role="tab" aria-controls="app-tab-pane" aria-selected="true">Aplikasi</button>
        </li>
        <li class="nav-item w-auto p-1" role="presentation">
            <button class="nav-link" id="setting-tab" data-bs-toggle="tab" data-bs-target="#setting-tab-pane" type="button" role="tab" aria-controls="setting-tab-pane" aria-selected="false">Pengaturan</button>
        </li>
        <li class="nav-item w-auto p-1" role="presentation">
