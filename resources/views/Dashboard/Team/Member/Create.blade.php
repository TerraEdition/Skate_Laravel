            ...
            <div class="col-md-8">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="member" name="member"
                        class="@error('member') is-invalid @enderror" value="{{ old('member') }}">
                    @error('member')
                ...
                <div class="mb-3">
                    <label for="birth" class="form-label">Tahun Lahir
                        <x-required />
                    </label>
                    <input type="number" min="1990" class="form-control" id="birth" name="birth"
                        class="@error('birth') is-invalid @enderror" value="{{ old('birth') }}" max="{{ date('Y') }}">
                    @error('birth')
                        <small class="text-danger ms-2">{{ $message }}</small>
                    @enderror
                </div>
