            ...
            <div class="col-md-8">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="member" name="member"
                        class="@error('member') is-invalid @enderror" value="{{ old('member', $data->member) }}">
                    @error('member')
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="birth" min="1990" name="birth"
                        class="@error('birth') is-invalid @enderror" value="{{ old('birth', $data->birth) }}"
                        max="{{ (date('Y') }}">
                    @error('birth')
                        <small class="text-danger ms-2">{{ $message }}</small>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="phone" name="phone"
                        class="@error('phone') is-invalid @enderror" value="{{ old('phone', $data->phone) }}">
                    @error('phone')
                        <small class="text-danger ms-2">{{ $message }}</small>
                    @enderror
                </div>
