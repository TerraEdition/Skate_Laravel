...
@section('content')
    <form action="{{ url()->current() }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="team_initial" name="team_initial"
                        class="@error('team_initial') is-invalid @enderror" value="{{ old('team_initial') }}">
                    @error('team_initial')
                        <small class="text-danger ms-2">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="coach" name="coach"
                        class="@error('coach') is-invalid @enderror" value="{{ old('coach') }}">
                    @error('coach')
                        <small class="text-danger ms-2">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="web" name="web" placeholder="https://"
                        class="@error('web') is-invalid @enderror" value="{{ old('web') }}">
                    @error('web')
                        <small class="text-danger ms-2">{{ $message }}</small>
                    @enderror
                </div>
                <div class="mb-3">
                    <div class="row">
                        ...
                        <div class="col-6 mb-2">
                            <input type="text" class="form-control" id="contact_name" name="contact[0][name]"
                                class="@error('contact.0.name') is-invalid @enderror" value="{{ old('contact.0.name') }}">
                            @error('contact.*.name')
                                <small class="text-danger ms-2">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-6 mb-2">
                            <input type="number" class="form-control" id="phone" name="contact[0][phone]"
                                class="@error('contact.0.phone') is-invalid @enderror"
                                value="{{ old('contact.0.phone') }}">
                            @error('contact.*.phone')
                                <small class="text-danger ms-2">{{ $message }}</small>
                            @enderror
                        </div>
            ...
            <div class="col-md-4">
                <img src="{{ asset('storage/image/profile/default.png') }}" alt="logo"
...
@section('js')
    ...
    <script>
        document.querySelector('#team').addEventListener('keyup', function() {
            ...
            document.querySelector('#team_initial').value = inisialTim;
        });
